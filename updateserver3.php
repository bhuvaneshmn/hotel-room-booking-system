...
$sql1 = "UPDATE roomdetail SET specification='AC,WiFi,Music' WHERE roomno='$_POST[roomno]'";
...
<header>
	...
	<div class="fwimage1">
		...
		<h4 class="home4"><?php echo "Roomno $_POST[roomno] has AC,WiFi,Music facilities"; ?></h4>
